            ...
            {[1, 2, 3].map((p) => (
              <button
                ...
                style={{
                  ...
                  border: '1px solid',
                  borderColor: priority === p ? (p === 3 ? 'var(--color-danger)' : p === 2 ? 'var(--color-orange)' : 'var(--color-blue)') : 'var(--color-border)',
                  backgroundColor: priority === p ? (p === 3 ? 'var(--color-danger)' : p === 2 ? 'var(--color-orange)' : 'var(--color-blue)') : 'var(--color-surface)',
                      ...
                      {[1, 2, 3].map((p) => (
                        <button
                          ...
                          style={{
                            ...
                            borderRadius: 'var(--radius-md)',
                            border: '1px solid',
                            borderColor: editingTask.priority === p ? (p === 3 ? 'var(--color-danger)' : p === 2 ? 'var(--color-orange)' : 'var(--color-blue)') : 'var(--color-border)',
                            backgroundColor: editingTask.priority === p ? (p === 3 ? 'var(--color-danger)' : p === 2 ? 'var(--color-orange)' : 'var(--color-blue)') : 'var(--color-surface)',
